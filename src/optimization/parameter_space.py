...
PARAMETER_SPACE: list[Parameter] = [
    ...
    Parameter(
        ...
        current_value=12, min_value=10, max_value=17, step=1,
        value_type="int",
    ...
    Parameter(
        ...
        current_value=5.5, min_value=5.0, max_value=7.5, step=0.5,
        value_type="float",
    ...
    Parameter(
        ...
        current_value=120, min_value=48, max_value=168, step=24,
        value_type="int",
